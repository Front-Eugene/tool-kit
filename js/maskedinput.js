...
!(function (a) {
  ...
  function e(b) {
      ...
      for (
        ...
        switch (((g = f[0]), g.charAt(0))) {
          ...
          case b.groupmarker.end:
            if (((h = o.pop()), o.length > 0)) {
              if (((i = o[o.length - 1]), i.matches.push(h), i.isAlternator)) {
                ...
                o.length > 0
                  ? ((i = o[o.length - 1]), i.matches.push(j))
                  : n.matches.push(j);
              }
          ...
          case b.alternatormarker:
            o.length > 0
              ? ((i = o[o.length - 1]), (k = i.matches.pop()))
              : (k = n.matches.pop()),
              k.isAlternator
                ? o.push(k)
                : ((j = new d(!1, !1, !1, !0)), j.matches.push(k), o.push(j));
            break;
          default:
            if (o.length > 0) {
              if (
                ((i = o[o.length - 1]),
                i.matches.length > 0 &&
                  ((k = i.matches[i.matches.length - 1]),
                  k.isGroup &&
                    ((k.isGroup = !1),
              ...
              n.matches.length > 0 &&
                ((k = n.matches[n.matches.length - 1]),
                k.isGroup &&
                  ((k.isGroup = !1),
                  e(k, b.groupmarker.start, 0),
                  e(k, b.groupmarker.end))),
    ...
    function d(d, e) {
      ...
      return (
        void 0 == a.inputmask.masksCache[d] &&
          (a.inputmask.masksCache[d] = {
            mask: d,
            maskToken: c(d),
            validPositions: {},
            _buffer: void 0,
    ...
    function e(a) {
      if (((a = a.toString()), b.numericInput)) {
        ...
        for (var c = 0; c < a.length; c++)
          a[c] == b.optionalmarker.start
            ? (a[c] = b.optionalmarker.end)
            : a[c] == b.optionalmarker.end
            ? (a[c] = b.optionalmarker.start)
            : a[c] == b.groupmarker.start
            ? (a[c] = b.groupmarker.end)
            : a[c] == b.groupmarker.end && (a[c] = b.groupmarker.start);
        a = a.join("");
      }
      return a;
    }
  ...
  function f(d, e, f) {
        ...
        for (e = b; h >= e; e++) {
          ...
          if (void 0 != l) {
            ...
            (i =
              ...
              n[e] &&
              ((void 0 != n[e + 1] &&
                s(e + 1, n[e].locator.slice(), e).length > 1) ||
                void 0 != n[e].alternation)
                ? e + 1
                : B(e)),
              (j = r(i, l.match.def)
                ? j && y(i, l.input, !0, !0) !== !1
    ...
    function o(a, b, c, d) {
      var e,
        g = a;
      (k().p = a),
        void 0 != k().validPositions[a] &&
          k().validPositions[a].input == f.radixPoint &&
          (b++, g++);
      for (e = g; b > e; e++)
        void 0 != k().validPositions[e] &&
          (c === !0 || 0 != f.canClearPosition(k(), e, m(), d, f)) &&
      ...
      for (l(!0), e = g + 1; e <= m(); ) {
        ...
        void 0 != i && void 0 == h
          ? (r(g, i.match.def) &&
              y(g, i.input, !0) !== !1 &&
              (delete k().validPositions[e], e++),
            g++)
          : e++;
      }
      var j = m();
      j >= a &&
        void 0 != k().validPositions[j] &&
        k().validPositions[j].input == f.radixPoint &&
        delete k().validPositions[j],
        l(!0);
    }
    function p(a, b, c) {
      for (
        var d,
          e = s(a, b, c),
          g = m(),
          h = k().validPositions[g] || s(0)[0],
          i =
            void 0 != h.alternation ? h.locator[h.alternation].split(",") : [],
          j = 0;
        j < e.length &&
        ((d = e[j]),
        !(
          d.match &&
          ((f.greedy && d.match.optionalQuantifier !== !0) ||
          ...
          (void 0 == h.alternation ||
            (void 0 != d.locator[h.alternation] &&
              x(d.locator[h.alternation].toString().split(","), i)))
        ));
        j++
      );
      return d;
    ...
    function q(a) {
      return k().validPositions[a]
        ? k().validPositions[a].match
        : s(a)[0].match;
    }
    function r(a, b) {
    ...
    function s(b, c, d) {
      function e(c, d, f, h) {
        function l(f, h, n) {
          ...
          if (g == b && void 0 == f.matches)
            return i.push({ match: f, locator: h.reverse() }), !0;
          if (void 0 != f.matches) {
            if (f.isGroup && n !== !0) {
                ...
                for (var A = 0; A < s.matches.length; A++) {
                  ...
                  for (var C = 0; C < r.length; C++)
                    for (var D = r[C], E = 0; E < t.length; E++) {
                      var F = t[E];
                      if (
                        D.match.mask == F.match.mask &&
                        ("string" != typeof w ||
                          -1 != a.inArray(D.locator[v].toString(), x))
                      ) {
                        r.splice(C, 1),
              ...
              for (
                var G = f, H = d.length > 0 && n !== !0 ? d.shift() : 0;
                H < (isNaN(G.quantifier.max) ? H + 1 : G.quantifier.max) &&
                b >= g;
                H++
              ) {
      ...
      if (void 0 == c) {
        for (
          var l, m = b - 1;
          void 0 == (l = k().validPositions[m]) && m > -1;
    ...
    function v(a, b, c) {
      if (((c = c || u().slice()), a === !0)) l(), (a = 0), (b = c.length);
        ...
        for (var d = a; b > d; d++)
          delete k().validPositions[d], delete k().tests[d];
      for (var d = a; b > d; d++)
    ...
    function x(b, c) {
      for (
        var d = f.greedy ? c : c.slice(0, 1), e = !1, g = 0;
        g < b.length;
        g++
      )
    ...
    function y(b, c, d, e) {
      function g(b, c, d, e) {
        var g = !1;
        return (
          a.each(s(b), function (h, i) {
            for (
              var j = i.match, p = c ? 1 : 0, q = "", r = (u(), j.cardinality);
              r > p;
              r--
            )
              q += D(b - (r - 1));
            if (
              ...
              var t = b;
              if (
                (void 0 != g.remove && o(g.remove, g.remove + 1, !0),
                g.refreshFromBuffer)
              ) {
              ...
              return 1 != g && void 0 == g.pos && void 0 == g.c
                ? !1
                : (h > 0 && l(!0),
                  n(t, a.extend({}, i, { input: w(s, j) }), e) || (g = !1),
                  !1);
            }
          }),
          g
      ...
      function h(b, c, d, e) {
        ...
        for (g = m(); g >= 0; g--)
          if (
            k().validPositions[g] &&
            void 0 != k().validPositions[g].alternation
          ) {
        ...
        if (void 0 != h)
          for (var j in k().validPositions)
            if (
              ...
              void 0 === k().validPositions[j].alternation
            ) {
              for (
                var n = k().validPositions[j],
                  o = n.locator[h],
                  p = k().validPositions[g].locator[h].split(","),
                  q = 0;
                q < p.length;
                q++
              )
      ...
      function i(b, c) {
        for (
          var d = k().validPositions[c], e = d.locator, f = e.length, g = b;
          c > g;
          g++
        )
          if (!z(g)) {
      ...
      for (p++; b > p; p++)
        void 0 == k().validPositions[p] &&
          (((!z(p) || j[p] != F(p)) && s(p).length > 1) ||
            j[p] == f.radixPoint ||
            ("0" == j[p] && a.inArray(f.radixPoint, j) < p)) &&
          g(p, j[p], !0);
      var q = b,
        r = !1,
      ...
      if (q < A() && ((r = g(q, c, d, e)), !d && r === !1)) {
        ...
        if (
          !C ||
          null != C.match.fn ||
          (C.match.def != c && c != f.skipOptionalPartCharacter)
        ) {
      ...
      if (
        (r === !1 && f.keepStatic && N(j) && (r = h(b, c, d, e)),
        r === !0 && (r = { pos: q }),
    ...
    function B(a) {
      ...
      for (
        var c = a;
        ++c < b && !z(c) && (f.nojumps !== !0 || f.nojumpsThreshold > c);
    ...
    function D(a) {
      return void 0 == k().validPositions[a]
        ? F(a)
        : k().validPositions[a].input;
    }
    ...
    function F(a, b) {
      return (
        ...
        void 0 != b.placeholder
          ...
          : null == b.fn
          ? b.def
          : f.placeholder.charAt(a % f.placeholder.length)
      );
    }
    function G(b, c, d, e) {
      function f() {
      ...
      n && n.length > 0 && (g.splice(0, n.length * j.length), (i = B(i))),
        a.each(g, function (c, e) {
          ...
          if (!f() || d) {
            var o = d
              ? c
              : null == n.match.fn && n.match.optionality && j + 1 < k().p
              ? j + 1
              : k().p;
        ...
        c &&
          E(b, u(), a(b).is(":focus") ? B(m(0)) : void 0, a.Event("checkval"));
    }
    function H(b) {
      ...
      for (
        ...
        (d.optionality ||
          ...
          (i &&
            ...
            -1 != a.inArray(h[c].locator[i.alternation].toString(), l))) &&
          e[c] == F(c, d));
        c--
      )
        f--;
    ...
    function N(b) {
      ...
      if (void 0 == d.def || d.def.newBlockMarker || d.def.optionalQuantifier) {
        ...
        for (var g = 0; e >= g; g++) {
          ...
          if (
            (h &&
              void 0 == k().validPositions[g] &&
              i.optionality !== !0 &&
              i.optionalQuantifier !== !0) ||
            (!h && b[g] != F(g))
          ) {
            c = !1;
            break;
                ...
                g
                  ? ((e = d(
                      ...
                      a.isFunction(g.opts.onBeforeMask)
                        ? g.opts.onBeforeMask.call(mb, c, g.opts) || c
                        : c
                    )),
        ...
        c
          ? (i.call(
              ...
              a.isFunction(c.opts.onBeforeMask)
                ? c.opts.onBeforeMask.call(mb, b, c.opts) || b
                : b
            ),
    ...
    function R(b, c, d, e) {
      ...
      if (
        (c == a.inputmask.keyCode.BACKSPACE &&
        (d.end - d.begin < 1 || 0 == f.insertMode)
          ? (d.begin = C(d.begin))
          : c == a.inputmask.keyCode.DELETE &&
            d.begin == d.end &&
            (d.end = z(d.end) ? d.end + 1 : B(d.end) + 1),
        o(d.begin, d.end, !1, e),
        e !== !0)
      ) {
        g();
    ...
    function S(c) {
      ...
      (c.ctrlKey && 88 == g && !b("cut"))
        ? (c.preventDefault(),
          ...
          d._valueGet() == t().join("")
            ? e.trigger("cleared")
            : N(u()) === !0 && e.trigger("complete"),
          f.showTooltip && e.prop("title", k().mask))
        ...
        ? K(d, 0, c.shiftKey ? i.begin : 0)
        : ((f.undoOnEscape && g == a.inputmask.keyCode.ESCAPE) ||
            (90 == g && c.ctrlKey)) &&
          c.altKey !== !0
        ? (G(d, !0, !1, $.split("")), e.click())
    ...
    function T(b, c, d, e, g) {
      ...
      if (
        ...
        (b.ctrlKey || b.metaKey || gb)
      )
        return !0;
      if (j) {
        46 == j && 0 == b.shiftKey && "," == f.radixPoint && (j = 44);
        var m,
          o = c ? { begin: g, end: g } : K(h),
          p = String.fromCharCode(j),
          q = O(o.begin, o.end);
        q &&
          ((k().undoPositions = a.extend(!0, {}, k().validPositions)),
        ...
        if (t !== !1) {
          if (
            ...
            m =
              !f.keepStatic &&
              ((void 0 != w[r + 1] &&
                s(r + 1, w[r].locator.slice(), r).length > 1) ||
                void 0 != w[r].alternation)
                ? r + 1
                : B(r);
          }
          k().p = m;
        ...
        if (d !== !1) {
          ...
          if (
            ...
            q &&
              ((k().buffer = void 0), (k().validPositions = k().undoPositions));
        } else
          q &&
            ((k().buffer = void 0), (k().validPositions = k().undoPositions));
        if (
          (f.showTooltip && i.prop("title", k().mask),
    ...
    function U(b) {
      ...
      if ("paste" == b.type) {
        ...
        h == t().slice(0, g.begin).join("") && (h = ""),
          ...
          window.clipboardData && window.clipboardData.getData
            ? (e = h + window.clipboardData.getData("Text") + i)
            : b.originalEvent &&
              b.originalEvent.clipboardData &&
              b.originalEvent.clipboardData.getData &&
              (e = h + b.originalEvent.clipboardData.getData("text/plain") + i);
      }
      var j = e;
      ...
      return (
        G(c, !0, !1, db ? j.split("").reverse() : j.split("")),
        d.click(),
    ...
    function X(b) {
      var c = this,
        d = _ || K(c);
      0 == b.originalEvent.data.indexOf(ab) &&
        (l(), (d = { begin: 0, end: 0 }));
    ...
    function Z(b) {
      if (((bb = a(b)), bb.is(":input") && c(bb.attr("type")))) {
        if (
          (bb.data("_inputmask", { maskset: e, opts: f, isRTL: !1 }),
        ...
        bb.unbind(".inputmask"),
          ...
          bb
                ...
                (hb = !0),
                  ...
                  "" != e &&
                    ...
                    N(g) === !1 &&
                      ...
                      f.clearIncomplete &&
                        (l(), (g = f.clearMaskOnLostFocus ? [] : t().slice()))),
                    E(d, g, void 0, b));
              }
            })
            .bind("focus.inputmask", function () {
              var b = (a(this), this),
                c = b._valueGet();
              f.showMaskOnFocus &&
                (!f.showMaskOnHover || (f.showMaskOnHover && "" == c)) &&
                b._valueGet() != u().join("") &&
                E(b, u(), B(m())),
                ($ = u().join(""));
            })
              ...
              if (b.is(":focus")) {
                ...
                if (d.begin == d.end)
                  if (
                    f.radixFocus &&
                    "" != f.radixPoint &&
                    -1 != a.inArray(f.radixPoint, u()) &&
                    (hb || u().join("") == t().join(""))
                  )
                    K(c, a.inArray(f.radixPoint, u())), (hb = !1);
                  else {
            ...
            .bind(j + ".inputmask dragdrop.inputmask drop.inputmask", U)
          ...
          i ||
            bb
              .bind("compositionstart.inputmask", W)
              .bind("compositionupdate.inputmask", X)
              .bind("compositionend.inputmask", Y),
    ...
    if (void 0 != d)
      switch (d.action) {
        ...
        case "format":
          ...
          var ib = (
            a.isFunction(f.onBeforeMask)
              ? f.onBeforeMask.call(bb, d.value, f) || d.value
              : d.value
          ).split("");
          return (
            G(bb, !1, !1, db ? ib.reverse() : ib),
            a.isFunction(f.onBeforeWrite) &&
              f.onBeforeWrite.call(this, void 0, u(), 0, f),
            d.metadata
              ? {
        ...
        case "remove":
          ...
          Object.getOwnPropertyDescriptor &&
            (nb = Object.getOwnPropertyDescriptor(mb, "value")),
            nb && nb.get
              ? mb._valueGet &&
                Object.defineProperty(mb, "value", {
                  get: mb._valueGet,
                  set: mb._valueSet,
                })
              : document.__lookupGetter__ &&
                mb.__lookupGetter__("value") &&
                mb._valueGet &&
                (mb.__defineGetter__("value", mb._valueGet),
        ...
        case "getmetadata":
          if (
            ...
            for (var pb, qb = m(), rb = qb; rb >= 0; rb--)
              if (
                k().validPositions[rb] &&
                void 0 != k().validPositions[rb].alternation
              ) {
                pb = k().validPositions[rb].alternation;
                break;
              }
            return void 0 != pb
              ? e.metadata[k().validPositions[qb].locator[pb]]
              : e.metadata[0];
          }
          return e.metadata;
      }
  ...
  if (void 0 === a.fn.inputmask) {
    var g = navigator.userAgent,
      ...
      i =
        (null !== g.match(new RegExp("android.*safari.*", "i")),
      ...
      (a.fn.inputmask = function (b, c) {
        ...
        if ("string" == typeof b)
          switch (b) {
            ...
            case "unmaskedvalue":
              var j = a(this);
              return j.data("_inputmask")
                ? f({ action: "unmaskedvalue", $input: j })
                : j.val();
            case "remove":
          ...
          if ("object" == typeof b)
            return (
              (i = a.extend(!0, {}, a.inputmask.defaults, b)),
              d(i.alias, b, i),
              (h = e(i)),
              void 0 == h
                ? this
...
$(document).ready(function () {
  if (window.location.href.indexOf("/ua/") > -1) {
    $('input[name="phone"]')
      .inputmask("+375(99)999-99-99", { clearIncomplete: true })
      .attr("type", "tel");
  } else {
    $('input[name="phone"]')
      .inputmask("+375(99)999-99-99", { clearIncomplete: true })
